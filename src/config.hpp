...
#define USE_MPI 1
#define USE_NCCL 0
#define USE_SPDLOG 0  // Set by CMake if found
#define USE_OPENSSL 0  // Set by CMake if found
...
#define MAX_TILE_SIZE 1024  // Default tile size for cache optimization
#define MIN_TILE_SIZE 64    // Minimum tile size
#define DYNAMIC_TILE_SIZING 1  // Enable dynamic tile sizing based on model size
